...
// DEFINIMOS LOS UL 
const allTaskUl = document.getElementById("allTaskUl") as HTMLUListElement;
const todoUl = document.getElementById("todoUl")  as HTMLUListElement;
const doingUl = document.getElementById("doingUl") as HTMLUListElement;
const doneUl = document.getElementById("doneUl") as HTMLUListElement;
const deletedUl = document.getElementById("deletedUl") as HTMLUListElement;
...
const tareaForm = document.getElementById("tareaForm") as HTMLFormElement;
...
const tareaAClonar = document.getElementById("componenteTareaCont") as HTMLLIElement;
const lista = tareaAClonar.firstElementChild as HTMLLIElement;
...
const estadosTemplate : HTMLElement = estadosClonar.cloneNode(true) as HTMLElement;
...
function addElemento(element : Tarea, creado:boolean){
    ...
    const template : HTMLElement = lista.cloneNode(true) as HTMLElement;
...
elementosLista.addEventListener("click", (e) => {
    ...
    let targetEvento = e.target as HTMLElement;
